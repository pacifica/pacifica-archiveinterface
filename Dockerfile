...
RUN yum -y update && \
    yum -y install wget unzip autoconf automake make gcc gcc-c++ libtool-devel libtool libtool-ltdl-devel libtool-ltdl file glib2 glib2-devel doxygen texlive-latex texlive texlive-dvips && \
